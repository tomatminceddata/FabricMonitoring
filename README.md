...
this measure determines the state of a setting,
    ...
    ```
# Why I’m doing this´
If you are wondering why I’m doing this, on February 22nd, 2024, a new setting appeared, all the above helps to easily spot new sttings, and this is only the most obvious use case.
